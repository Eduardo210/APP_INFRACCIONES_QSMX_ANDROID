...
data class InfractionSearch(@SerializedName("Flag") val flag: Boolean,
                            ...
                            @SerializedName("InfraccionIdDisposicion") val id_disposition: Int,
                            @SerializedName("InfraccionDisposicion") val disposition: String, //TODO: new
                            ...
                            @SerializedName("InfraccionDomicilioEstado") val infraction_state: String,//TODO: new
                            @SerializedName("InfraccionDomicilioIdMunicipio") val id_address_township: Int,
                            @SerializedName("InfraccionDomicilioMunicipio") val infraction_township: String, //TODO: new
                            ...
                            @SerializedName("InfractorDomicilioIdEstado") val infractor_id_state: Int,
                            @SerializedName("InfractorDomicilioEstado") val infractor_state: String,
    ...
    data class Fractions(@SerializedName("FraccionIdFraccion") val id_fraction: Int,
                         @SerializedName("Articulo") val art: String,
                         @SerializedName("Fraccion") val fracc: String,
