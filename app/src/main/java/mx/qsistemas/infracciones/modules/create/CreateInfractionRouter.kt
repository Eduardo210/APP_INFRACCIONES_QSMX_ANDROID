...
class CreateInfractionRouter(val activity: ActivityHelper) : CreateInfractionContracts.Router {
    ...
    override fun presentOffenderFragment(direction: Direction) {
        activity.loadFragment(OffenderFragment.newInstance(), R.id.container_infraction, direction, false)
    }

    override fun presentPayerFragment(isNewInfraction: Boolean, direction: Direction) {
        activity.loadFragment(PayerFragment.newInstance(isNewInfraction), R.id.container_infraction, direction, false)
    }
}