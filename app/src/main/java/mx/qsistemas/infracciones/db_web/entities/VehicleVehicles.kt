...
data class VehicleVehicles(@PrimaryKey(autoGenerate = true) val id: Long,
                          ...
                          /* @ColumnInfo(name = "plate") val plate: String,
                           ...
                           @ColumnInfo(name = "class_type") val class_type: String,
                           ...
                           @ColumnInfo(name = "identifier_document")  val identifier_document: String,
                           @ColumnInfo(name = "issued_in_id") val issued_in_id: String,
                           @ColumnInfo(name = "issued_in") val issued_in: String,
                           @ColumnInfo(name = "num_document") val num_document: String,
                           @ColumnInfo(name = "document_type_id") val document_type_id: String,
