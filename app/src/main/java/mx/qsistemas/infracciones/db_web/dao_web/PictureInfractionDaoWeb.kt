...
interface PictureInfractionDaoWeb {
    ...
    suspend fun insertList(pictures: MutableList<InfringementPicturesInfringement>)
    ...
    suspend fun selectPicturesToSend(idInfraction: Long): MutableList<InfringementPicturesInfringement>
}