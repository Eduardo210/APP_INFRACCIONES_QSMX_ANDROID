...
data class VehicleInfraction(@PrimaryKey(autoGenerate = true) @ColumnInfo(name = "ID_VEHICULO") val id: Int,
                             ...
                             @ColumnInfo(name = "MODELO") val model: String, // Año del vehículo
                             ...
                             @ColumnInfo(name = "ID_INFRACCION") val id_infra: Int)